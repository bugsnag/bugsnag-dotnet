...
namespace Bugsnag.Clients.Test
{
    public class ClientTests
    {
        ...
        public void Constructor_InstallExceptionHandlerIfAutoNotiyIsOn()
        {
            ...
            // Act
            var testClient = new BaseClient(TestApiKey, true, null, null, mockExceptionHandler.Object);
        ...
        public void Constructor_DoNotInstallExceptionHandlerIfAutoNotiyIsOff()
        {
            ...
            // Act
            var testClient = new BaseClient(TestApiKey, false, null, null, mockExceptionHandler.Object);
        ...
        public void StartAutoNotify_InstallExceptionHandlerEverytime(bool autoNotify)
        {
            ...
            var testClient = new BaseClient(TestApiKey, autoNotify, null, null, mockExceptionHandler.Object);
            mockExceptionHandler.Setup(x => x.InstallHandler(It.IsAny<Action<Exception, bool>>()))
        ...
        public void Notify_DoNothingIfTheEventIsNull()
        {
            ...
            var testClient = new BaseClient(TestApiKey, false, null, mockNotifier.Object, null);
        ...
        public void Notify_DoNothingIfWeDontNotifyOnThisReleaseStage()
        {
            ...
            var testClient = new BaseClient(TestApiKey, false, mockConfig.Object, mockNotifier.Object, null);
        ...
        public void Notify_CallingNotifyFromExceptionWithoutSeverityDefaultToWarning()
        {
            ...
            var mockConfig = new Mock<IConfiguration>();
            var mockExceptionHandler = new Mock<IExceptionHandler>();
            var testClient = new BaseClient(TestApiKey, false, mockConfig.Object, mockNotifier.Object, mockExceptionHandler.Object);
            var testExp = new StackOverflowException("Test Stack Overflow");
        ...
        public void HandleDefaultException_NotifyIsCalledAsPartOfDefaultHandler()
        {
            ...
            // Act
            var testClient = new BaseClient(TestApiKey, true, mockConfig.Object, mockNotifier.Object, mockExceptionHandler.Object);
